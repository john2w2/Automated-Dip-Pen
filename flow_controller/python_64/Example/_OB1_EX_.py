...
sys.path.append('C:\Users\Luke\Desktop\Megan\python_64\DLL64'.encode('utf-8')) #add the path of the library here
sys.path.append('C:\Users\Luke\Desktop\Megan\python_64'.encode('utf-8'))#add the path of the LoadElveflow.py
...
error=OB1_Initialization('01868D03'.encode('ascii'),1,2,4,3,byref(Instr_ID)) 
...
#add one digital flow sensor with water calibration (OB1 MK3+ only for MK3, it return error 8000)
#error=OB1_Add_Sens(Instr_ID, 1, 1, 1, 0)
#print('error add digit flow sensor:%d' % error)


#add one analog flow sensor
error=OB1_Add_Sens(Instr_ID, 2, 1, 0, 0)
...
while repeat==True:
    ...
    Calib_path='C:\\Users\\Marchand\\Desktop\\test\\Calibration\\Calib.txt'
    if answer=='default':
